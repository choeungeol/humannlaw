...
class HnlUsersController extends JoshController
{
    /**
    ...
    public function index()
    {
        ...
        // Show the page
        return view('hnl.users.index', compact('users'));
    }
    ...
    public function create()
    {
        ...
        // Show the page
        return view('hnl.users.create', compact('groups', 'countries'));
    }
    ...
    public function store(UserRequest $request)
    {
        ...
        try {
            ...
            return Redirect::route('hnl.users.index')->with('success', Lang::get('users/message.success.create'));

        } catch (LoginRequiredException $e) {
            $error = Lang::get('hnl/users/message.user_login_required');
        } catch (PasswordRequiredException $e) {
            $error = Lang::get('hnl/users/message.user_password_required');
        } catch (UserExistsException $e) {
            $error = Lang::get('hnl/users/message.user_exists');
        }
    ...
    public function edit($user = null)
    {
        ...
        // Show the page
        return view('hnl.users.edit', compact('user', 'roles', 'userRoles', 'countries', 'status'));
    }
    ...
    public function update(User $user, UserRequest $request)
    {
        ...
        try {
            ...
            if ($user->save()) {
                ...
                return Redirect::route('hnl.users.edit', $user)->with('success', $success);
            }
            ...
            return Redirect::route('hnl.users.index')->with('error', $error);
        }

        // Redirect to the user page
        return Redirect::route('hnl.users.edit', $user)->withInput()->with('error', $error);
    }
    ...
    public function getDeletedUsers()
    {
        ...
        // Show the page
        return view('hnl.deleted_users', compact('users'));
    }
    ...
    public function destroy($id = null)
    {
        try {
            ...
            if ($user->id === Sentinel::getUser()->id) {
                // Prepare the error message
                $error = Lang::get('hnl/users/message.error.delete');
            ...
            // Redirect to the user management page
            return Redirect::route('hnl.users.index')->with('success', $success);
        } catch (UserNotFoundException $e) {
            // Prepare the error message
            $error = Lang::get('hnl/users/message.user_not_found', compact('id'));
    ...
    public function show($id)
    {
        ...
        // Show the page
        return view('hnl.users.show', compact('user'));
    ...
    public function lockscreen($id){
        $user = Sentinel::findUserById($id);
        return view('hnl.lockscreen',compact('user'));
    }
