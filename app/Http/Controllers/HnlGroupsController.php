...
class HnlGroupsController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // Show the page
        return view('hnl.groups.index', compact('roles'));
    }
    ...
    public function edit($id = null)
    {
        ...
        // Show the page
        return view('hnl.groups.edit', compact('role'));
    }
