                                ...
                                <input type="hidden" name="id" value="{{ $id }}">
                                    ...
                                    <tr>
                                        ...
                                        @empty
                                            @foreach($payitem1 as $p1)
                                            <td>
                                                <input type="text" class="form-control input-sm" name="inputA{{$p1->id}}" value="{!! ($p1->title === '기본급') ? $mtotal: '' !!}{!! ($p1->title === '주휴수당') ? $mbreak: ''!!}" {!! ($p1->title === '기본급') || ($p1->title === '주휴수당') ? 'readonly' : '' !!} >
                                            </td>
                                            @endforeach
                                        @endforelse
                                    ...
                                    <tr>
                                        ...
                                        @empty
                                            @foreach($payitem2 as $p2)
                                                <td>
                                                    <input type="text" class="form-control input-sm" name="inputB{{$p2->id}}" value="{{ ($p2->title === '연장수당') ? $mover : '' }}{{ ($p2->title === '야간수당') ? $mnight : '' }}{{ ($p2->title === '휴일수당') ? $mwwork : '' }}{{ ($p2->title === '휴일연장') ? $mwover : '' }}{{ ($p2->title === '휴일야간') ? $mwnight : '' }}{{ ($p2->title === '연차수당') ? $mwbt : '' }}" {!! ($p2->title === '연장수당') || ($p2->title === '야간수당') || ($p2->title === '휴일수당') || ($p2->title === '휴일연장') || ($p2->title === '휴일야간') || ($p2->title === '연차수당') ? 'readonly' : '' !!} >
                                                </td>
                                            @endforeach
                                        @endforelse
                                    </tr>
